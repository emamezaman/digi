...
<div id="show_product_cat1">
	 ...
	 <div class="row">
        ...
        <div class="col-md-3 pr0 pl0 box">
			...
			<div class="cat_list">
				<ul class="cat_list_ul">
					<li>
						...
						<a href="{{url('category').'/'.$category1->title_en.'/'.$category2->title_en.'/'.$category3->title_en}}">
              <span>{{$category3->title_fa}} </span></a>
				  <ul class="cat_list_ul">
				  	<?php $a=array(); ?>
                     ...
                     <li>
                       <?php
  $url='/';
  $e=explode('_', $value->title_en);
   if(sizeof($e)==3){
    if($e[0]=='filter'){
      $url.='search'.'/'.$category1->title_en.'/'.$category2->title_en
        .'/'.$category3->title_en.'/'.'?'.$e[1].'[0]='.$e[2];

    }else{
      $url.='category'.'/'.$category1->title_en.'/'.$category2->title_en
         .'/'.$category3->title_en.'/'.$value->title_en;
    }
   }else{
     $url.='category'.'/'.$category1->title_en.'/'.$category2->title_en
         .'/'.$category3->title_en.'/'.$value->title_en;
          ...
          <div class="box" style="margin-bottom: -12px">
               ...
               <ul class="list-inline">
                  ...
                  <li>
                   ...
                   <li>
                     <a href="{{url('category').'/'. $category1->title_en.'/'. $category2->title_en.'/'. $category3->title_en}}">
                      {{ $category3 ?  $category3->title_fa : '' }}</a>
