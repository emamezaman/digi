...
@endif
			<div class="cat_list">
				<ul class="cat_list_ul">
					<li>
						...
						<a href="{{url('category').'/'.$category1->title_en}}"><span>{{$category1->title_fa}}</span></a>
				  <ul class="cat_list_ul">
				  	
				  @foreach ($cat_list as $key => $value) 
				  
                     <li>
                     	<a href="{{url('category'.'/'.$category1->title_en.'/'.$value->title_en)}}">
      ...
      <div class="search_product_div">
          ...
          <div class="col-md-6">
            ...
            <div>
                <label>({{ $category1 ? $category1->title_fa : '' }}</label>
                <span>نمایش </span>
                <span>1</span>
                <span>تا</span>
