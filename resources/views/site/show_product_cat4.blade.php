...
<div id="show_product_cat1">
	 ...
	 <div class="row">
        ...
        <div class="col-md-3 box pr0 pl0 ">
      ...
      @if($search_price['min_price'] != $search_price['max_price'])
            ...
            <div class="search_min_max_price">
  ...
  @endif
          ...
          <div class="box" style="margin-bottom: -12px">
               ...
               <ul class="list-inline">
                  ...
                  <li>
                   ...
                   <li>
                     <a href="{{url('category').'/'. $category1->title_en.'/'. $category2->title_en.'/'. $category3->title_en.'/'. $category4->title_en}}">
                      {{ $category4 ?  $category4->title_fa : '' }}</a>
      ...
      <div class="search_product_div">
          ...
          <div class="col-md-6">
            ...
            <div>
                <label>({{ $category3 ? $category4->title_fa : '' }}</label>
                <span>نمایش </span>
                <span>1</span>
                <span>تا</span>
