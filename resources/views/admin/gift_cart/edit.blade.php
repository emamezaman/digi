...
@endif
    ...
    <div   class="panel panel-primary">
      ...
      {!! Form::model($gift_cart,['url'=>'admin/gift_cart/order/'.$gift_cart->id,'method'=>'PUT'])!!}
     ...
     <div class="form-group input-group col-md-12" >
      ...
      {!!Form::text('value',null,['class'=>'form-controll '])!!}
      ...
      <span class="input-group-addon" style="width: 200px;">اعتبار کارت تا تاریخ</span>
        {!!Form::text('date',null,['class'=>'form-controll pdate','id'=>'date1','style'=>'width: 96%!important;'])!!}
      </div>

      <div  class="form-group col-md-12">
      <button class="btn btn-success" type="submit">ویرایش کن</button>
      </div>
