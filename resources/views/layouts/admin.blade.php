...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="asset('layoutAdmin/css/owl.carousel.css')}}" type="text/css">
  ...
  <section id="container" class="">
      ...
      <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="#" class="logo">پنل مدریتی</a>
            <!--logo end-->
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{asset('layoutAdmin/img/avatar-mini.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{asset('layoutAdmin/img/avatar-mini2.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{asset('layoutAdmin/img/avatar-mini3.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{asset('layoutAdmin/img/avatar-mini4.jpg')}}"></span>
                                    <span class="subject">
            ...
            <div class="top-nav ">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" src="{{asset('layoutAdmin/img/avatar1_small.jpg')}}">
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a   href="{{url('admin/discount/order/create')}}">ایجاد</a></li>
                          <li><a   href="{{url('admin/discount/order')}}">نمایش و مدریت</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a   href="{{url('admin/gift_cart/order/create')}}">ایجاد</a></li>
                          <li><a   href="{{url('admin/gift_cart/order')}}">نمایش و مدریت</a></li>
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                          ...
                          <span>مدریت گروه ها</span>
                          <span class="arrow"></span>
                      </a>
                      <ul class="sub">
                          <li><a class="" href="{{route('category.create')}}">ایجاد</a></li>
                          <li><a class="" href="{{route('category.index')}}">نمایش و مدریت</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a href="{{url('admin/slider/create')}}" >ایجاد</a></li>
                          <li><a class="" href="{{url('admin/slider')}}">نمایش و مدریت</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                         <a class="" href="{{url('admin/filter')}}"><span>ثبت فیلتر محصول</span></a>
                 </li>
                 <li class="sub-menu">
                        <a class="" href="{{url('admin/item')}}"><span>مشخصات تخصصی محصول</span></a>
                </li>

                  <li class="sub-menu">
                      <a href="#" class="">
                          <i class=""></i>
                          <span>مدریت استان</span>
                          <span class="arrow"></span>
                      </a>
                      <ul class="sub">
                          <li><a class="" href="{{url('admin/ostan/create')}}">جدید</a></li>
                          <li><a class="" href="{{url('admin/ostan')}}">نمایش و مدریت</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="{{url('admin/shar/create')}}">جدید</a></li>
                          <li><a class="" href="{{url('admin/shar')}}">نمایش و مدریت</a></li>
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                          ...
                          <span>مدریت محصولات</span>
                          <span class="arrow"></span>
                      </a>
                      <ul class="sub">
                          <li><a class="" href="{{url('admin/product/create')}}">جدید</a></li>
                          <li><a class="" href="{{url('admin/product')}}">نمایش و مدریت</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="{{url('admin/order')}}">نمایش و مدریت</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="{{url('admin/user/create')}}">جدید</a></li>
                          <li><a class="" href="{{url('admin/user')}}">نمایش و مدریت</a></li>
                   ...
                   <li>
                      <a href="{{url('admin/comment')}}">
                        ...
                        @if($count_comment > 0)
                        <span class="btn btn-danger" title="نظر جدید">{{ $count_comment }}</span>
                        @endif
                      </a>
                  </li>
                   ...
                   <li>
                      <a href="{{url('admin/question')}}">
                        ...
                        <span> پرسش کاربران</span>
                        @if($count_question > 0)
                        <span class="btn btn-danger" title="نظر جدید">{{ $count_question }}</span>
                        @endif
                      </a>
                  </li>

                  <li>
                      <a href="{{url('admin/setting/pay')}}">
                        <span class=""></span>
    ...
    {{-- <script src="{{asset('layoutAdmin/js/jquery.js')}}"></script> --}}
    ...
    <script src="{{asset('layoutAdmin/js/owl.carousel.js')}}" ></script>
    ...
    <script src="{{asset('angularjs/admin_angular.js')}}"></script>
    @yield('footer')
